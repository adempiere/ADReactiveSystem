...
object PackageImp {
  ...
  def create(packageImpId: Int,
             ...
             updatedDate: String,
             uninstall: Boolean,
             uuId: String) = PackageImp(packageImpId, isActive, created, createdBy, updated, updatedBy, name,
    None, None, None, None, description, None, processed, processing, None, None, None, None, None, None)
}