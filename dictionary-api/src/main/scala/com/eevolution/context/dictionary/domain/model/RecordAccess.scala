...
/**
  ...
  * @param recordId Record Access ID
...
case class RecordAccess(roleId: Int,
                        tenantId: Int,
                        recordId: Int,
                        organizationId: Int,
                        entityId: Int,
...
object RecordAccess  {
  ...
  def create(roleId: Int,
             ...
             uuid: String) = RecordAccess(recordId, roleId, tenantId, organizationId, entityId, isActive,
