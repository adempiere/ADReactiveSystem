...
case class TreeNodePR1(treeNodePRId: Int,
                       nodeId: Int,
...
object TreeNodePR1  {
  implicit lazy val jsonFormat = Jsonx.formatCaseClass[TreeNodePR1]
  def create(treeNodePRId: Int,
             ...
             parentId: Int,
             seqNo: Int,
             uuid: String) = TreeNodePR1(treeNodePRId, nodeId, isActive, created, createdBy, updated, updatedBy,
    None, None, None)
}
