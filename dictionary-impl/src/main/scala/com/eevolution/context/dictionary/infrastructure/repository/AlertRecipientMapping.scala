...
/**
  * Alert Recipient Mapping
  */

trait AlertRecipientMapping {
  val queryAlertRecipient = quote {
    querySchema[AlertRecipient]("AD_AlertRecipient",
      _.alertRecipientId-> "AD_AlertRecipient_ID",
