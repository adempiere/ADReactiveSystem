...
trait ChangeLogMapping {
  val queryChangeLog = quote {
    querySchema[ChangeLog]("AD_ChangeLog",
      _.changeLogId-> "AD_ChangeLog_ID",
      ...
      _.undo -> "Undo",
      _.redo -> "Redo",
      _.isCustomization -> "IsCustomization",
      _.trxName -> "TrxName",
      _.description-> "Description",
      _.eventChangeLog -> "EventChangeLog",
      _.uuid-> "UUID")
  }
}
