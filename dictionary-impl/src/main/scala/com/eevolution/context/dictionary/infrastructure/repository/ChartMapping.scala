...
trait ChartMapping {
  val queryChart = quote {
    querySchema[Chart]("AD_Chart",
      ...
      _.isDisplayLegend-> "IsDisplayLegend",
      _.chartOrientation-> "ChartOrientation",
      _.isTimeSeries-> "IsTimeSeries",
      _.timeUnit-> "TimeUnit",
      _.timeScope-> "TimeScope",
      _.domainLabel-> "DomainLabel",
      _.rageLabel-> "RangeLabel",
      _.uuid-> "UUID")
  }
}
