...
trait EmailConfigMapping {
  val queryEmailConfig = quote {
    querySchema[EmailConfig]("AD_EmailConfig",
      _.emailConfigId-> "AD_EmailConfig_ID",
      _.tenantId-> "AD_Client_ID",
      _.organizationId-> "AD_Org_ID",
      _.authMechanism-> "AuthMechanism",
      _.connectionTimeout-> "ConnectionTimeOut",
      _.created-> "Created",
