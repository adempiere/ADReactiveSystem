...
/**
  * Organization Info Mapping
  */

trait OrganizationInfoMapping {
  val queryOrganizationInfo = quote {
    querySchema[OrganizationInfo]("AD_OrgInfo",
