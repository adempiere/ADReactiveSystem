...
/**
  * Pin Stance Log Mapping
  */

trait PinStanceLogMapping {
  val queryPinStanceLog = quote {
    querySchema[PinStanceLog]("AD_PinStance_Log",
      _.pinStanceLogId-> "AD_PinStance_Log_ID",
