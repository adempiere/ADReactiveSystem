...
/**
  * Print Label Line Mapping
  */
trait PrintLabelLineMapping  {
  val queryPrintLabelLine = quote {
    querySchema[PrintLabelLine]("AD_PrintLabelLine",
      _.printLabelLineId -> "AD_PrintLabelLine_ID",
      ...
      _.name -> "Name",
      _.seqNo -> "SeqNo",
      _.labelFormatType -> "LabelFormatType",
