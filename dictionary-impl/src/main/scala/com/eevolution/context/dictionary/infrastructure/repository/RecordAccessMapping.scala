...
/**
  * Record Access Mapping
  */

trait RecordAccessMapping {
  val queryRecordAccess = quote {
    querySchema[RecordAccess]("AD_Record_Access",
      _.roleId-> "AD_Role_ID",
      ...
      _.isDependentEntities-> "IsDependentEntities",
      _.uuid-> "UUID")
  }
}
