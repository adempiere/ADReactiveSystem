...
trait ReferenceEntityMapping {
  val queryReferenceEntity = quote {
    querySchema[ReferenceEntity]("AD_Ref_Table",
      ...
      _.key ->"AD_Key" ,
      _.display -> "AD_Display" ,
      _.isValueDisplayed -> "IsValuedDisplayed",
      _.whereClause -> "WhereClause",
      _.orderByClause -> "OrderByClause" ,
      _.entityType -> "EntityType",
      _.windowId ->  "AD_Window_ID" ,
      _.isAlert -> "IsAlert",
      _.displaySQL -> "DisplaySQL",
      _.isDisplayIdentifier -> "IsDisplayIdentifier",
      _.uuid-> "UUID")
  }
}
