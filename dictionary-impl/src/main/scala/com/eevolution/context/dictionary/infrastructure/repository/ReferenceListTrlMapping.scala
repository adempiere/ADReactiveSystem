...
/**
  * Reference List Trl Mapping
  */

trait ReferenceListTrlMapping {
  val queryReferenceListTrl = quote {
    querySchema[ReferenceListTrl]("AD_Ref_List",
      _.referenceListId-> "AD_Ref_List_ID",
