...
/**
  * Replication Document Mapping
  */

trait ReplicationDocumentMapping {
  val queryReplicationDocument = quote {
    querySchema[ReplicationDocument]("AD_ReplicationDocument",
      _.replicationDocumentId-> "AD_ReplicationDocument_ID",
