...
trait ReplicationMapping {
  val queryReplication = quote {
    querySchema[Replication]("AD_Replication",
      _.replicationId-> "AD_Replication_ID",
      ...
      _.isRMIOverHTTP-> "IsRMIOverHTTP",
      _.processing-> "Processing",
      _.idRangeStart-> "IDRangeStart",
      _.isRangeEnd-> "IDRangeEnd",
      _.remoteClientId-> "Remote_Client_ID",
      _.remoteOrganizationId-> "Remote_Org_ID",
      _.prefix-> "Prefix",
      _.suffix-> "Suffix",
