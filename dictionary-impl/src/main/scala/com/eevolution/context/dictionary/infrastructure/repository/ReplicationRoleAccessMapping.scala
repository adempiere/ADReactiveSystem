...
/**
  * Replication Role Access Mapping
  */

trait ReplicationRoleAccessMapping {
  val queryReplicationRoleAccess = quote {
    querySchema[ReplicationRoleAccess]("AD_ReplicationRoleAccess",
      _.replicationRoleAccessId-> "AD_ReplicationRoleAccess_ID",
