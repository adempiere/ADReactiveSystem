...
/**
  * Role Organization Access Mapping
  */

trait RoleOrganizationAccessMapping {
  val queryRoleOrganizationAccess = quote {
    querySchema[RoleOrganizationAccess]("AD_Role_OrgAccess",
      _.roleId-> "AD_Role_ID",
