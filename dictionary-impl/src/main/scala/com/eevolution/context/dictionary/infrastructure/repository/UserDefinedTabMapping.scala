...
trait UserDefinedTabMapping {
  val queryUserDefinedTab = quote {
    querySchema[UserDefinedTab]("AD_UserDef_Tab",
      _.userDefinedTabId -> "AD_UserDef_Tab_ID",
      ...
      _.tabId-> "AD_Tab_ID",
      _.isMultiRowOnly-> "IsMultiRowOnly",
      _.name-> "Name",
