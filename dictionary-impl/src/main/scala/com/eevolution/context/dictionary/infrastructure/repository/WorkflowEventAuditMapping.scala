...
/**
  * Workflow Event Audit Mapping
  */

trait WorkflowEventAuditMapping {
  val queryWorkflowEventAudit = quote {
    querySchema[WorkflowEventAudit]("AD_WF_EventAudit",
      _.workflowEventAuditId-> "AD_WF_EventAudit_ID",
