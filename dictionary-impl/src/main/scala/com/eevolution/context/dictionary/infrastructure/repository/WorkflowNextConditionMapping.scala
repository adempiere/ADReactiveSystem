...
/**
  * Workflow Next Condition Mapping
  */

trait WorkflowNextConditionMapping {
  val queryWorkflowNextCondition = quote {
    querySchema[WorkflowNextCondition]("AD_WF_NextCondition",
      _.workflowNextConditionId-> "AD_WF_NextCondition_ID",
