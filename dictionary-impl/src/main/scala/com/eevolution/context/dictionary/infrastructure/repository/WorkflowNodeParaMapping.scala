...
/**
  * Workflow Node Para Mapping
  */

trait WorkflowNodeParaMapping {
  val queryWorkflowNodePara = quote {
    querySchema[WorkflowNodePara]("AD_WF_Node_Para",
      _.workflowNodeParaId-> "AD_WF_Node_Para_ID",
