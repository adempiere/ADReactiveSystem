...
/**
  * Workflow Process Data Mapping
  */

trait WorkflowProcessDataMapping {
  val queryWorkflowProcessData = quote {
    querySchema[WorkflowProcessData]("AD_WF_ProcessData",
      _.workflowProcessDataId-> "AD_WF_ProcessData_ID",
