...
/**
  * Zoom Condition Mapping
  */

trait ZoomConditionMapping {
  val queryZoomCondition = quote {
    querySchema[ZoomCondition]("AD_ZoomCondition",
      _.zoomConditionId-> "AD_ZoomCondition_ID",
